...
private:
	...
	std::shared_ptr<JoystickButton> turnTo0;
	std::shared_ptr<JoystickButton> turnTo90;
	std::shared_ptr<JoystickButton> turnTo180;
	std::shared_ptr<JoystickButton> turnTo270;
public:
	OI();
